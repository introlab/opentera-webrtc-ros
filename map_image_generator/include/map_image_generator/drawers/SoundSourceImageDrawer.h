...
#include <odas_ros/msg/odas_sst_array_stamped.hpp>
...
namespace map_image_generator
{
    ...
    {
        rclcpp::Subscription<odas_ros::msg::OdasSstArrayStamped>::SharedPtr m_soundSourcesArraySubscriber;
        odas_ros::msg::OdasSstArrayStamped::ConstSharedPtr m_lastSoundSourcesArray;
    ...
    private:
        ...
        void drawSoundSource(cv::Mat& image, const odas_ros::msg::OdasSst& source, tf2::Transform poseInRef);
        void drawConcentricCircles(cv::Mat& image, int x, int y, int radius, double colorRatio);

        static tf2::Transform getPoseFromSst(const odas_ros::msg::OdasSst& sst);
